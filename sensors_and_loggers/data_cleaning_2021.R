...
####
# Oct 11 2021
# Plot: 67, Collected: Oct 10 2021
# Issue: freezing temps

rm(list = ls())

dataraw = read.csv('sensors_and_loggers/data/plot67_2021-09-27_2021-10-09_raw.TXT')
...
# Export
write.csv(dataout, 'sensors_and_loggers/data/plot67_2021-09-27_2021-10-09_proc.TXT',
          row.names = FALSE, na = '')
